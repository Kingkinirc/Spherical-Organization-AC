PROGRAM ANALYSISMULTIRINGINSPHERE
    ...
    INTEGER:: i, j, k, w, time, m, n1, n2, p, q, ab
    ...
    !OPEN(unit=32, file="arc3_300_n6_rCM_vf0.2.csv", status="unknown")
    OPEN(unit=33, file="arc3_300_n6_CoMdist_vf0.2.csv", status="unknown")
    OPEN(unit=34, file="arc3_300_n6_mondist_vf0.2.csv", status="unknown")
    OPEN(unit=35, file="arc3_300_n6_mondistloops_vf0.2.csv", status="unknown")
    OPEN(unit=36, file="arc3_300_n6_rmonbignsmall_vf0.2.csv", status='unknown')
    OPEN(unit=51, file="arc3_300_n6_cummondist_vf0.2.csv", status="unknown")
    OPEN(unit=52, file="arc3_300_n6_cummondistloops_vf0.2.csv", status="unknown")
    OPEN(unit=53, file="arc3_300_n6_extracalc_vf0.2.csv", status="unknown")
