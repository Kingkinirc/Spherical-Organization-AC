PROGRAM ANALYSISMULTIRINGINSPHERE
    ...
    REAL*8,ALLOCATABLE:: mondist150(:), mondist200(:), mondist250(:), mondist75(:)
    REAL*8,ALLOCATABLE:: timeavgmondist150(:),timeavgmondist200(:),timeavgmondist75(:),timeavgmondist250(:)
    REAL*8:: densitybig, densitysmall, n2, a, b, c, f
    REAL*8:: rmon50, rmon100, rmon75, rmon150, denbig, densmall
    ...
    OPEN(unit=33, file="arc1_200_n1_cldist_vf0.2.csv", status="unknown")
    ...
    timeavgmondist200= 0.0d0; timeavgmondist250=0.0d0; timeavgmondist75=0.0d0
    DO time = 1, niter
        ...
        !r2CMloop1=0.0d0; rCMloop2=0.0d0; r2CMloop2=0.0d0; rCMloop3=0.0d0; r2CMloop3=0.0d0
            DO i = 1, nring
                ...
                elseif (k.eq.75) then
                    rmon75 = dsqrt((pos(ab,1))**2 + (pos(ab,2))**2 + (pos(ab,3))**2)
                    n1 = int(rmon75/shellsize)
                    mondist75(n1) = mondist75(n1) + 1
                endif
                !endif
                ENDDO
            ENDDO
            ...
            timeavgmondist75 = timeavgmondist75 + mondist75
    ...
    timeavgmondist75 = timeavgmondist75/dfloat(niter*nring)
